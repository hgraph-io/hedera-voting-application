      ...
      <Grid item xs={12}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.middle}>
            <Button className={styles.cardButton} onClick={() => updateApplicationStatus(submission.id, 'pending')} variant="outlined">
              Pending
            </Button>
          </div>
          ...
          <div className={styles.right}>
            <div>
              <Button className={styles.cardButton} onClick={() => updateApplicationStatus(submission.id, 'not selected')} variant="outlined">
                Not Selected
              </Button>
            </div>
          </div>
